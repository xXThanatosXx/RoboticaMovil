...
const int    C1R = 2;    // Entrada de la señal B del encoder Amarillo.
const int    C2R = 3;    // Entrada de la señal A del encoder verde.
int cvR = 0;
...
//////////////////////MOTOR IZQUIERDO///////////////////////////////
const int    C1L = 5;                  // Entrada de la señal B del encoder verde.
const int    C2L = 4;                  // Entrada de la señal A del cencoder Amarillo .
int cvL = 0;
...
//  motorL.setGains(0.28, 0.05, 0.05); // (Kc,Ti,Td)
    ...
    motorR.setGains(0.07 , 0.27, 0.05);
    motorL.setGains(0.07 , 0.27, 0.05);
